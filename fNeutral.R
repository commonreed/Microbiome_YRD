...
library(Hmisc)
library(stats4)
fNeutral <- function(spp){ 
  #R code of the neutral community model
  ...
  write.csv(p, file = "output/p.csv")
  write.csv(freq, file = "output/freq.csv")
  write.csv(freq.pred, file = "output/freq.pred.csv")
